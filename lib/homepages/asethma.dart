...
class Asethma extends StatefulWidget {
  const Asethma({Key? key}) : super(key: key);

  @override
  _AsethmaState createState() => _AsethmaState();
}

class _AsethmaState extends State<Asethma> {
  @override
                ...
                child: Column(
                  children: [
                    ...
                    Container(
                      ...
                      height: 190,
                      width: 340,
                      child: Image.asset('assets/img/aseth.png'),
                    ),
                    SizedBox(height: 20,),
                    Padding(
                    ...
                    Row(
                      ...
                      children: [
                         InkWell(
                             ...
                             child: Icon(Icons.navigate_before_rounded,size: 48,)),
